...
message(STATUS "topic_demo: 1 messages, 1 services")

set(MSG_I_FLAGS "-Itopic_demo:/home/masterxu/MyWorkspace/src/topic_demo/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/masterxu/MyWorkspace/src/topic_demo/srv/Greeting.srv" NAME_WE)
add_custom_target(_topic_demo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "topic_demo" "/home/masterxu/MyWorkspace/src/topic_demo/srv/Greeting.srv" ""
)

get_filename_component(_filename "/home/masterxu/MyWorkspace/src/topic_demo/msg/gps.msg" NAME_WE)
add_custom_target(_topic_demo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "topic_demo" "/home/masterxu/MyWorkspace/src/topic_demo/msg/gps.msg" ""
)
...
_generate_msg_cpp(topic_demo
  "/home/masterxu/MyWorkspace/src/topic_demo/msg/gps.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_cpp(topic_demo
  "/home/masterxu/MyWorkspace/src/topic_demo/srv/Greeting.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/topic_demo
)
...
### Generating Services
_generate_srv_nodejs(topic_demo
  "/home/masterxu/MyWorkspace/src/topic_demo/srv/Greeting.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/topic_demo
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/topic_demo)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/topic_demo\")")
  # install generated code
  install(
