...
if("FALSE" STREQUAL "TRUE")
  set(topic_demo_SOURCE_PREFIX /home/masterxu/MyWorkspace/src/topic_demo)
  set(topic_demo_DEVEL_PREFIX /home/masterxu/MyWorkspace/src/cmake-build-debug/devel)
  ...
  set(topic_demo_INSTALL_PREFIX /usr/local)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'topic_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
